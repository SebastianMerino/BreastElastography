...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% After temporal fintering,a 2-D FIR filter using 2-D window method is performed using a
% spatial bandpass filter with cutoffs cs_min & cs_max. Then 4 complex
% matrix are obtained: 

% Inputs:      f - vibration frequency
